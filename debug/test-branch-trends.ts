...
async function testBranchTrends(): Promise<void> {
  ...
  try {
    ...
    const weeklyChartData = branchTrendsService.formatDataForChart(
      weeklyTrendData,
      utilStart,
      utilEnd,
      true,
    ...
    const dailyChartData = branchTrendsService.formatDataForChart(
      dailyTrendData,
      utilStart,
      utilEnd,
      false,
...
testBranchTrends().catch(console.error);
